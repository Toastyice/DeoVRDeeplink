...
public class DeoVrVideoResponse
{
    ...
    /// <summary>
    /// Gets or sets the list of available subtitles for the video.
    /// </summary>
    [JsonPropertyName("subtitles")]
    public List<DeoVrSubtitle> Subtitles { get; set; } = [];
}
...
/// <summary>
/// Represents a subtitle track for a DeoVR video.
/// </summary>
public class DeoVrSubtitle
{
